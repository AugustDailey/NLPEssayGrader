...
public class NLP {
	...
	public static void main(String[] args) throws IOException, PrinterException {
		...
		// String text = "Mary saw a ring through the window and asked John for
		// it.";
		...
		for (CoreMap sentence : sentences) {
			...
			// System.out.println(t.subjectLemmaGloss() + "\t" +
			// t.relationLemmaGloss() + "\t" + t.objectLemmaGloss());
			// }
			//
			...
			// List<Pair<GrammaticalRelation,IndexedWord>> s =
			// dependencies.childPairs(predicate);
			// for (Pair<GrammaticalRelation,IndexedWord> item : s) {
			// if (item.first.toString().equals("nsubj")) {
			// subject = item.second;
			// }
			// if (item.first.toString().equals("cop") &&
			// (item.second.originalText().toLowerCase().equals("are") ||
			// item.second.originalText().toLowerCase().equals("is"))) {
			// goodToGo = true;
			// }
			...
			// }
			//
			// List<Pair<GrammaticalRelation,IndexedWord>> t =
			// dependencies.childPairs(subject);
			...
			// if (quantifier != null) output += quantifier + "(x): " +
			// subject.lemma().toString() + "(x) ^ ";
			// if (PredicateLevelNegation) output += "not(";
			// if (quantifier == null) {
			// output += predicate.originalText() + "(" +
